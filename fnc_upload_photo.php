<?php
	...
	function store_photo_data($image_file_name, $alt, $privacy, $orig_name){
		...
		$statement = $conn->prepare("INSERT INTO vr_2021_photos (vr21_photos_userid, vr21_photos_filename, vr21_photos_alttext, vr21_photos_privacy, vr21_photos_origname) VALUES (?, ?, ?, ?, ?)");
		echo $conn->error;
