<?php
    class Upload_photo {
        ...
        private $temp_image;
        public $new_temp_image;       // hiljem kui class hakkab kõike ise tegema, siis muudame private peale
        ...
        function __destruct() {
            if(isset($this->new_temp_image)) {
                @imagedestroy($this->new_temp_image);       // @ märk keelab veateate/hoiatuse kuvamist, pigem tuleks lahendada miks hoiatust kuvab
            }
